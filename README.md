...
I also have my own business, [Synify](https://www.synify.net), where we host private and public game servers for customers, I have majorly modified the panel based on [Pterodactyl Panel](https://github.com/pterodactyl/panel). The github for the business is [here](https://github.com/synify-ltd)
